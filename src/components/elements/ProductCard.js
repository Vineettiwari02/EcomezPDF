            ...
            <div className="p-5">
              <Link to={`/products/${id}`}>
                ...
                <p className="flex justify-between items-center">
                    ...
                    <button onClick={() => addToCart(product)} className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800">Add To Cart <i className="ml-1 bi bi-plus-lg"></i></button>
