...
export const Login = () => {
  ...
  async function handleLoginGuest() {
    email.current.value = "vineet@gmail.com";
    password.current.value = "vineet@gmail.com";
    try {
